...
export const STORAGE_KEYS = {
  ...
  CLIENTS: 'builder_athlete_clients',
  EXERCISES_CUSTOM: 'builder_athlete_exercises_custom',
  EXERCISES_OVERRIDES: 'builder_athlete_exercises_overrides',
  EXERCISES_DELETED: 'builder_athlete_exercises_deleted',
  WORKOUT_PLANS: 'builder_athlete_workout_plans',
  WORKOUT_LOGS: 'builder_athlete_workout_logs',
  ATHLETE_CHAT_MESSAGES: 'builder_athlete_chat_messages',
  GOOGLE_CALENDAR_CONFIG: 'builder_athlete_google_calendar_config',
  PROGRESSION_SCHEMES: 'builder_athlete_progression_schemes',
  SIDEBAR_EXPANDED_GROUPS: 'builder_athlete_sidebar_expanded_groups',
  ATHLETE_INITIAL_ANAMNESIS: 'builder_athlete_initial_anamnesis',
  ATHLETE_MID_CHECKS: 'builder_athlete_mid_checks',
  NUTRITION_TEMPLATES: 'builder_athlete_nutrition_templates',
  QUESTIONNAIRE_TEMPLATES: 'builder_athlete_questionnaire_templates',
  QUESTIONNAIRE_RESPONSES: 'builder_athlete_questionnaire_responses',
} as const;
