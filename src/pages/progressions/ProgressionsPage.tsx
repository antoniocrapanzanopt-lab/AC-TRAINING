      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-800 pb-5">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-400 mt-1">
            Libreria unica e centralizzata: crea, genera con IA o seleziona modelli di sovraccarico per i tuoi atleti.
          </p>
        </div>
        ...
        <div className="flex items-center gap-2.5 self-start sm:self-auto">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs transition-all shadow-md shadow-purple-600/20 cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[var(--color-primary)] text-black font-black text-xs hover:bg-[var(--color-primary-hover)] transition-all shadow shadow-amber-500/10 cursor-pointer"
          >
