      ...
      <div className="bg-slate-950 border border-slate-800 rounded-3xl p-6 sm:p-7 max-w-lg w-full space-y-6 shadow-2xl relative overflow-hidden my-auto max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4 relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[var(--color-primary)] via-amber-400 to-cyan-400 p-0.5 shadow-xl shadow-[var(--color-primary)]/30 shrink-0">
              <div className="w-full h-full bg-slate-950 rounded-[14px] flex items-center justify-center relative overflow-hidden">
                <img src="/ac-logo-transparent.png" alt="AC" className="w-full h-full object-contain scale-115" />
                <span className="absolute top-1.5 right-1.5 w-2.5 h-2.5 rounded-full bg-cyan-400 shadow-sm shadow-cyan-400" />
              </div>
            </div>
            <div>
